...
```{r}
daily_new_cases <- read_csv("../data/processed/case data/usa-facts/03-29-2020/daily_new_cases_03292020.csv")

pop_full <- read_csv("../data/raw/census data/population/cc-est2018-alldata.csv") 
```
...
pred_plot_all <- ggarrange(pred_plot[[1]], pred_plot[[2]], pred_plot[[3]], pred_plot[[4]], pred_plot[[5]], pred_plot[[6]], pred_plot[[7]], pred_plot[[8]], pred_plot[[9]], pred_plot[[10]], pred_plot[[11]], pred_plot[[12]], pred_plot[[13]], pred_plot[[14]], pred_plot[[15]], pred_plot[[16]], pred_plot[[17]], pred_plot[[18]], pred_plot[[19]], pred_plot[[20]],
                              ncol = 5, nrow = 4)
ggsave(filename = "../results/county local predictive plots/plot y and yhat on day.png", plot = pred_plot_all, width = 18, height = 10)
```
